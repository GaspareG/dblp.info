...
function draw(filter){
  ...
  var margin = {top: 50, right: 25, bottom: 25, left: 150};
  var width = (3+filter.length)*30 - margin.left - margin.right, height = ((2+coauths.length)*20) - margin.top - margin.bottom;
  ...
  var y = d3.scalePoint().domain([[id, filter.length]].concat(coauths).map(function(d){
